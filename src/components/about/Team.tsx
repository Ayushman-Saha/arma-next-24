...
function Teams(){
    ...
    <div className="h-screen relative w-full bg-black flex flex-col items-center justify-center overflow-hidden rounded-md">
      ...
      <div className="h-full w-full bg-black flex flex-col items-center justify-center overflow-hidden rounded-md mt-24">
      ...
      <p className='text-center text-lg p-4 text-gray-400 mx-36'>
